            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
						...
						<li class="nav-item">
                            <a class="nav-link" href="/admin/addnew">
                            <i class="fa fa-fw fa-list"></i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/admin/editbanner">
                            <i class="fa fa-fw fa-list"></i>
                            <span class="nav-link-text">Изменить баннеры на главной</span>
                            </a>
                        </li>
						<li class="nav-item">
                            <a class="nav-link" href="/admin/info">
                            <i class="fa fa-fw fa-list"></i>
                            <span class="nav-link-text">Изменить информацию</span>
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <footer class="sticky-footer">
                <div class="container">
                    <div class="text-center">
                        <small>&copy; 2018, Тихий Дон</small>
                    </div>
                </div>
            </footer>
        <?php endif; ?>
